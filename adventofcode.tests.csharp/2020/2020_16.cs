...
namespace Year2020
{
    ...
    public class Day16
    {
        ...
        public void Sample()
        {
            var lines = Utils.ReadInput("2020", "16", "sample");
            Utils.SolveAndValidate(Tuple.Create(71L, 7L), AOC2020_16.Solve, lines);
        }

        [Fact]
        public void Actual()
        {
            var lines = Utils.ReadInput("2020", "16", "actual");
            Utils.SolveAndValidate(Tuple.Create(22977L, 998358379943L), AOC2020_16.Solve, lines);
        }
    }
}
