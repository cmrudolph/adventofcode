...
namespace Year2020
{
    ...
    public class Day21
    {
        ...
        public void Sample()
        {
            var lines = Utils.ReadInput("2020", "21", "sample");
            Utils.SolveAndValidate(Tuple.Create(5L, "mxmxvkd,sqjhc,fvjkl"), AOC2020_21.Solve, lines);
        }

        [Fact]
        public void Actual()
        {
            var lines = Utils.ReadInput("2020", "21", "actual");
            Utils.SolveAndValidate(Tuple.Create(2324L, "bxjvzk,hqgqj,sp,spl,hsksz,qzzzf,fmpgn,tpnnkc"), AOC2020_21.Solve, lines);
        }
    }
}
