...
{
    // We know this is as far as we need to go (based on solving it). Bake this in as an
    // optimization to make it easier to parallelize things
    ...
    private static HashResult GetHashResult(
        MD5 md5,
